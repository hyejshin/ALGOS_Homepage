...
<center><font size='5'><b> 일정 관리 </b></font>
...
<TABLE width="600px" border="0" cellspacing="0" cellpadding="0">
	<TR> 
        	...
        	<a href="./calendar/main.jsp?year=<%=year-1%>&month=<%=month%>">◀</a>
        	<STRONG><%=year%>년 </STRONG> <a href="./calendar/main.jsp?year=<%=year+1%>&month=<%=month%>">▶</a>  
      		</TD>
      		<TD>
        	<DIV align="center">
        	<a href="./calendar/main.jsp?year=<%=year%>&month=<%=month - 1%>">◀</a>  
        	<STRONG><%=month + 1%>월 </STRONG><a href="./calendar/main.jsp?year=<%=year%>&month=<%=month + 1%>">▶</a> 
        	</DIV>
      		</TD>
      		<TD> 
        	<DIV align="right">
        	<a href="index.jsp?contentPage=./calendar/main.jsp"></a><STRONG><%=year + "-" + (month + 1) + "-" + date%></STRONG>
        	</DIV>
      		</TD> 
    	</TR>
</TABLE>
...
while (rs.next()){
%>
<a href=index.jsp?contentPage=./calendar/content.jsp?year=<%=year%>&month=<%=month+1%>&day=<%=index%>&no=<%=rs.getInt("no")%> 
...
<DIV id='<%= "HideShow" + j%>'style="visibility:hidden;position:
                                absolute;
                                     left:369px; top:400px; width:150px; 
                                height:74px; z-index:1"> 
  					
<TABLE height='180px' width='150px' border='1' cellspacing='1' bgcolor='cccccc'>	
	<TR> 
		<TD colspan='2' bgcolor='cccccc' align='center' height='25'>
		<font size='2'><b>상세정보</b></TD>
	</TR>
	<TR> 
		<TD width='20px'  height='25' bgcolor='cccccc' align='center'>
