...
%>
	<table width="750">
		<tr>
			...
			<td class="head" width="150">성공여부</td>
		...
		<tr>
			<td class="head">내용</td>
			<td colspan="3"><textarea name="content" rows="20" cols="80" readonly><%=rs.getString("content")%></textarea></td>
		</tr>
		<tr>
...
<%
	...
	rs = stmt2.executeQuery(strSQL); 
	
	while(rs.next()){ 
	%>
	<table border='0' width='750' cellpadding='2' cellspacing='2'>
		<tr>     
