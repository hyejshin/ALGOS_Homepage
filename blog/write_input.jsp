...
<%
String realFolder = "";
String saveFolder = "/blog/filestorage";
String encType =  "UTF-8";

int sizeLimit = 10 * 1024 * 1024;
String savePath=application.getRealPath("/blog/filestorage");
...
String strSQL = "SELECT Max(num) FROM presentdb";
...
strSQL ="INSERT INTO presentdb (num, name, pass, email, title, contents, writedate, readcount, filename)";
